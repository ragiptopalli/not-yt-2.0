  ...
  return (
    <div className="header">
      <div className="header__left">
        ...
        <Link to="/">
          <div className="header__logo ms-4">
            <svg
              viewBox="0 0 90 20"
              preserveAspectRatio="xMidYMid meet"
              focusable="false"
      ...
      <div className="col col-md-6 col-lg-5 d-none d-md-flex align-items-center justify-content-center header__search">
        <div className="input-group ">
          <form onSubmit={handleSearch} className="d-flex w-100">
            ...
            />
            <button className="input-group-text rounded-0" type="submit">
              <svg
                viewBox="0 0 24 24"
                preserveAspectRatio="xMidYMid meet"
                focusable="false"
      ...
      <div className="header__right col-md-auto">
        <ul className="nav col-md-auto pl-0 align-items-center">
          <li>
          ...
          <li>
            <Link to="/" className="px-2 header__icons">
              <img src={user?.picture} width="30" alt="" />
            </Link>
          </li>
        </ul>
      </div>
